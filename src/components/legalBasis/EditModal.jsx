    ...
    useEffect(() => {
        if (selectedLegalBase) {
            ...
            setFormData({
                ...
                aspects: selectedLegalBase.aspects?.map((aspect) => aspect.aspect_id.toString()),
                document: selectedLegalBase.fileKey || selectedLegalBase.url
                    ? {
