...
/**
 * Retrieves a list of articles matching the specified name from the backend.
 ...
 */
export default async function getArticlesByName({ name, token }) {
    try {
        const response = await server.get('/articles/name', {
            headers: {
