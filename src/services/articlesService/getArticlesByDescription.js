...
/**
 * Retrieves a list of articles matching the specified description from the backend.
 ...
 */
export default async function getArticlesByDescription({ description, token }) {
    try {
        const response = await server.get('/articles/description', {
            headers: {
