...
describe("Error Component", () => {
  ...
  test("displays network error message correctly", () => {
    renderWithRouter(
      <Error title="Error de conexión" message="Revisa tu conexión a Internet e intenta de nuevo." />
    );
  ...
  test("displays unauthorized access message correctly", () => {
    renderWithRouter(
      <Error title="Acceso no autorizado" message="Asegúrate de tener los permisos necesarios." />
    );
  ...
  test("displays server error message correctly", () => {
    renderWithRouter(
      <Error title="Error en el servidor" message="Por favor, intenta nuevamente más tarde." />
    );
  ...
  test("displays default error message correctly", () => {
    renderWithRouter(
      <Error title="Algo mal sucedió" message="Por favor, espere un momento e intenta nuevamente." />
    );
