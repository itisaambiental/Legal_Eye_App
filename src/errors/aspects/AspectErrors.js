...
class AspectErrors {
    ...
    static errorMap = {
        ...
        [AspectErrors.NOT_FOUND]: {
            title: "No encontrado",
            message: "El aspecto no fue encontrado. Verifique su existencia recargando la app e intente de nuevo.",
        },
        [AspectErrors.MULTIPLE_NOT_FOUND]: {
            title: "No encontrado",
            message: "Uno o más aspectos no fueron encontrados. Verifique su existencia recargando la app e intente de nuevo.",
        },
        ...
        [AspectErrors.ASSOCIATED_BASES]: {
            ...
            message: "El aspecto está vinculado a uno o más fundamentos legales y no puede ser eliminado. Por favor, verifique e intente de nuevo.",
        },
        [AspectErrors.MULTIPLE_ASSOCIATED_BASES]: {
            ...
            message: ({ items }) =>
                items.length === 1
                    ...
                    : `Los aspectos ${items.join(", ")} están vinculados a uno o más fundamentos legales y no pueden ser eliminados. Por favor, verifique e intente de nuevo.`,
        },
    };
    ...
    static ErrorMessagesMap = {
        ...
        "The aspect is associated with one or more legal bases": AspectErrors.ASSOCIATED_BASES,
        "Aspects are associated with legal bases": AspectErrors.MULTIPLE_ASSOCIATED_BASES,
