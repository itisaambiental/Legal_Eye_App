 ...
 * @param {Array} props.selectLegalBasis - Array of selected legal basis.
 */

const ReqIdentificationModal = ({ isOpen, onClose, selectLegalBasis }) => {
  ...
  }, [isOpen, selectLegalBasis, onClose]);
        ...
        <ModalBody>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="col-span-2 w-full">
              ...
              />
              {errors.description && (
                <p className="mt-2 text-sm text-red">{errors.description}</p>
              )}
            </div>
